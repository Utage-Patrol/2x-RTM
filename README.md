...
# How do I use this?
1. Grab the ![latest version](https://github.com/Utage-Patrol/2x-RTM/releases)
...
4. Run 2x-RTM.py
5. All RTM files will be scaled to your specified size and moved to the "output" folder
